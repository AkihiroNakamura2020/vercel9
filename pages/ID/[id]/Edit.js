...
if(Item.storagelink !=null||Item.storagelink !=undefined){
  ...
  async function handleOnitsmeCard(e) {
    e.preventDefault();
    console.log('handleOnitsmeCard');

    const endpoint = youitsid;
     ...
     <Container >
      ...
      <Grid item xs={12} md={8} lg={9}>
       ...
       {ninja[0].username}
        ...
        {address}<EditOutlinedIcon onClick={()=>{setAddress(!addressflag)}}/>
        </Typography>
        ...
        <EmailOutlinedIcon width="30" height="30"　className={classes.imagemargin} /> 


        <br />

        <div>
        <Typography className={classes.titleback}>SNS link 登録・更新</Typography>
      ...
      <Typography variant="h4" component="h1" className={classes.titleback} gutterBottom>
          Introduction Films
      </Typography>
